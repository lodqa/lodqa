...
class TUILookup
  def initialize (semanticTypesFILE)
    ...
    dictionary.push(["cell dysfunction","T049"])
    dictionary.push(["cellular dysfunction","T049"])
    dictionary.push(["molecular dysfunction","T049"])
    dictionary.push(["cell malfunction","T049"])
    dictionary.push(["cellular malfunction","T049"])
    dictionary.push(["molecular malfunction","T049"])
    dictionary.push(["anatomical deformity","T190"])
    dictionary.push(["anatomical disorder","T190"])
    dictionary.push(["anatomical problem","T190"])
    dictionary.push(["abnormal body part","T190"])
    dictionary.push(["abnormal body","T190"])
