window.onload = function() {
  var loadSolution = lodqaClient.loadSolution,
    loadStubSolution = lodqaClient.loadSolutionStub,
    bindSolution = function(solution, presetation) {
      var data = {},
        domId = 'lodqa-results';
  ...
  var solution = loadStubSolution();

  bindSolution(solution, tablePresentation);
  bindSolution(solution, graphPresentation);
  bindSolution(solution, debugPresentotion);
}
