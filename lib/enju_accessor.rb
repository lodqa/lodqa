...
class EnjuAccessor
  ...
  def parse (sentence)
    ...
    graph_rendering  = get_graph_rendering(tokens, root, focus)
...

    {
      ...
      # :graph_rendering => graph_rendering  # A graphical rendering of the graph of predicate-argument relations
    }
  end
  ...
  def get_graph_rendering (tokens, root, focus)
...
if __FILE__ == $0
  parser = EnjuAccessor.new("http://bionlp.dbcls.jp/enju")
